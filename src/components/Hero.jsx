function Hero() {
    return(
        <div className="h-3/5 md:h-screen px-8 md:px-32 pt-11 md:pt-40 py-16 border border-black flex flex-col gap-2">
            ...
            <button type="button" className="btn-primary w-48 py-2 md:py-4 md:px-5 rounded-md mt-2.5 font-semibold flex justify-center items-center">Selected projects</button>
        </div>
    );
}
